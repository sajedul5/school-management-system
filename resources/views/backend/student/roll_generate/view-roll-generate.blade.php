          ...
          <div class="card">
            ...
            <div class="card-body">
              <form  action="{{route('student.year.class.wise')}}" method="GET" id="#myForm">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group" style="padding: 30px;">
                      <a id="search" name="search" class="btn btn-info btn-sm">Search</a>
                    </div>
                  </div>
                </div>
                <hr>
                ...
                <button type="submit" class="btn btn-info btn-sm">Roll Generate</button>
              </form>
            </div>
          </div>
          <!-- /.card -->
  ...
  $(document).on('click','#search',function(){
    ...
    $.ajax({
      ...
      success: function(data){
        $('#roll-generate').removeClass('d-nome');
        var html = '';
        $.each( data, function(key, v){
          ...
          '<td> <input type="text" class="form-control form-control-sm" name="roll[]" value="'+v.student_id+'"></td>'+
        });
