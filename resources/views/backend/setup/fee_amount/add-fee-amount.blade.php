                      ...
                      <div class="form-row">
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('amount') is-invalid @enderror"  placeholder="Amount" name="amount[]" value="{{(@$editData->amount)}}">
                            <span class="text-danger">{{($errors->has('amount'))?($errors->first('amount')):''}}</span>
                          </div>
                        </div>
                        <div class="form-group col-md-2" style="padding: 30px;">
                          <span class="btn  btn-info addeventmore"><i class="fa fa-plus-circle"></i></span>
                        </div>
                      </div>
                  </div>
                  <div class="form-group">
