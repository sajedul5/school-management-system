          ...
          <div class="card">
            <div class="card-header">
              <h3>@if(@$editData)
                ...
                Add Student Shift
                @endif
                <a href="{{route('setups.student.shift.view')}}" class="btn btn-sm btn-info float-right">
                  <i class="fa fa-list"></i> Student Shift List </a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"  placeholder="Shift Name" name="name" value="{{(@$editData->name)}}">
