...
<!-- jquery-validation -->
<script src="{{asset('public/backend')}}/plugins/validation/validate.min.js"></script>
<script src="{{asset('public/backend')}}/datepicker/daterangepicker.js"></script>
<script src="{{asset('public/backend')}}/datepicker/locales.min.js"></script>
...
<script type="text/javascript">
  $(function(){
    $('.singledatepicker').daterangepicker({
      ...
      locale:{
        format: 'DD-MM-YYYY',
        daysOfWeek:['Su','No','Tu','We'.'Fr','Sa'],
        firstDay: 0
      },
      minDate: '01/01/1930',
    },
    function(start){
      this.element.val(start.format('DD-MM_YYYY'));
